...
<?php include(APPPATH.'views/users/sidebar.php'); ?>
	...
	<div class="main-container"  >
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30" style="background-image: linear-gradient(to right,#f36523,#9c369a); ">
					<div class="pd-20">
						<h1  style="color:white;">Email List</h1>
					</div>
				</br></br>
					<div class="pb-20">
					    <div class="add" style="padding :20px;">
					     <a href="email_add"><button class="btn btn-primary" style="float:right;">Add +</button></a></div>
		...
		<tr>
			...
			<td scope="row"><?php echo $arti['user_id'] ?></td>
			<td scope="row"><?php echo $arti['contact_person'] ?></td>
			<td scope="row"><?php echo $arti['email_id'] ?></td>
			<td scope="row"><?php echo $arti['address'] ?></td>
			<td scope="row"><?php echo $arti['image_attachment'] ?></td>
			<td scope="row"><?php echo $arti['city_name'] ?></td>
			<td><a href="delete_email?id=<?php echo $arti['id']; ?>"><button class="btn btn-danger">Delete</button></a>
			<a href="update_emails?id=<?php echo $arti['id']; ?>"><button class="btn btn-secondary">Edit</button></a></td>
	...
	<?php include(APPPATH.'views/users/footerdatabase.php'); ?>		