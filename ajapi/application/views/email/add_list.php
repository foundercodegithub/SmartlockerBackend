...
<?php include(APPPATH.'views/users/sidebar.php'); ?>
	...
	<div class="main-container" >
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30" style="background-image: linear-gradient(to right,#f36523,#9c369a); ">
					<div class="pd-20">
						<h1  style="color:white;"> Crime  List</h1>
					</div>
				</br></br>
		...
		<tr>
			...
			<td scope="row" style="width:10px;"><?php echo $arti['description'] ?></td>
			...
			<td scope="row"><a href="crime_delete?id=<?php echo $arti['id']; ?>"><button class="btn btn-danger">Delete</button></a></td>
