			...
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12" >
					     ...
					     <h3 style=" margin-left:30px;  ">Add Email</h3>
				...
				<div class="pd-20 card-box mb-30" style="background-image: linear-gradient(to right,#f36523,#ec1f60); ">
					...
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard vertical" action="add_email" method="post">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" name="app_user" class="form-control" placeholder="Name..." style="border-radius: 13px; box-shadow: 3px 3px 3px;"></br>
										</div>
									...
									<div class="col-md-4">
									   <div class="form-group">
											...
											<input type="text" placeholder=" Mobile Num...." name="contact_person" class="form-control" style="border-radius: 13px; box-shadow: 3px 3px 3px;"></br>
									...
									<div class="col-md-4">
											...
											<input type="email" placeholder=" Email...." name="email_id" class="form-control" style="border-radius: 13px; box-shadow: 3px 3px 3px;"></br>
								...
								<div class=row>
									<div class="col-md-4">
									    ...
									    <div class="form-group">
											...
											<input type="text" placeholder=" Enter Date...." name="address" class="form-control" style="border-radius: 13px; box-shadow: 3px 3px 3px;"></br>
									...
									<div class="col-md-4">
											...
											<input type="text" placeholder=" Enter city name" name="city_name" class="form-control" style="border-radius: 13px; box-shadow: 3px 3px 3px;"></br>
