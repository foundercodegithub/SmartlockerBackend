<?php  include'sidebar.php';?>
    ...
    <div class="container-fluid">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">App user list</h1>
                   

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">App user list</h6>
                        </div>
                        <div class="card-body">
		...
		<tr style="color:black;">
			...
			<td scope="row"><a href="view_profile?id=<?php echo $arti['id']; ?>"><button class="btn btn-primary">view</button></a></td>
