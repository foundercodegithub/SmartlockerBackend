				...
				<div class="page-header">
					<div class="row" style="background:black;">
						<div class="col-md-6 col-sm-12" >
					     ...
					     <h3 style=" margin-left:30px; color:white; ">App User</h3>
						...
						<form class="tab-wizard wizard-circle wizard vertical" action="insert" method="post">
							...
							<section>
								<div class="row">
									...
									<div class="col-md-4">
									    <div class="form-group">
											<label style="color: black; font-size: 15px;" >Enter Age :</label>
											<input type="text" placeholder=" Age...." name="age" class="form-control" style="border-radius: 13px; box-shadow: 3px 3px 3px;background:rgb(207, 230, 240);"></br>
								...
								<div class=row>
									...
									<div class="col-md-4">
											...
											<input type="text" placeholder=" Enter City...." name="city" class="form-control" style="border-radius: 13px; box-shadow: 3px 3px 3px;background:rgb(207, 230, 240);"></br>
								...
								<div class="row">
									<div class="col-md-4">
									    <div class="form-group">
											<label style="color: black; font-size: 15px;" >Zipcode</label>
											<input type="text" placeholder=" Enter City...." name="zipcode" class="form-control" style="border-radius: 13px; box-shadow: 3px 3px 3px;background:rgb(207, 230, 240);"></br>
										...
										<div class="form-group">
											...
											<input type="text" value="India"name="country" class="form-control" style="border-radius: 13px; box-shadow: 3px 3px 3px;background:rgb(207, 230, 240);"></br>
