				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12" >
					     ...
					     <h3 style=" margin-left:30px;  ">App User</h3>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" name="name" class="form-control" placeholder=" Name..." style="border-radius: 13px; box-shadow: 3px 3px 3px;"></br>
										</div>
								...
								<div class="row">
									<div class="col-md-4">
									    <div class="form-group">
											...
											<input type="text" placeholder=" Enter City...." name="zipcode" class="form-control" style="border-radius: 13px; box-shadow: 3px 3px 3px;"></br>
