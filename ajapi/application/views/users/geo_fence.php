...
<?php include('sidebar.php'); ?>
	...
	<div class="main-container" >
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30" style="background-image: linear-gradient(to right,#f36523,#9c369a); ">
					<div class="pd-20">
						<h1  style="color:white;"> Geo fence  List</h1>
					</div>
				</br></br>
					...
					<div class="pb-20">
						...
						<table class="table hover multiple-select-row data-table-export nowrap">
							<thead>
								<tr>
				<th scope="col">id</th>
				<th scope="col">Geo Fence Distance</th>
		...
		<tr>
			...
			<td scope="row"><?php echo $arti['geo_fence_distance'] ?></td>
		
			<td scope="row"><?php echo $arti['created_at'] ?></td>
			<td scope="row"><?php echo $arti['updated_at'] ?></td>
			
			<td scope="row"><a href="delete_geo?id=<?php echo $arti['id']; ?>"><button class="btn btn-danger">Delete</button></a>
			<a href="update_geo?id=<?php echo $arti['id']; ?>"><button class="btn btn-secondary">Edit</button></a></td>
