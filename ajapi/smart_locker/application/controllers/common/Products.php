...
class Products extends CI_Controller
{
    ...
    public function details($slug = '')
    {
        ...
        $this->db->update('categories');
         ...
         $this->db->where('id',$id);
		$a=$this->db->get('products');
	
    	$this->data['abc']=$a->result_array();
    	//$this->loginmodel->getuserdata($id);
    ...
    public function links()
    {
        ...
        $data['abc']=$this->cart_model->getuserdata();
        $this->load->view('front-end/' . THEME . '/template',$data);
    }
