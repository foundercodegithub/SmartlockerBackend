...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#form">
  ...
  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#form1">
    Claime Your Free Domain
  </button> 
  <div class="modal fade" id="form1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content"style=" background-image: linear-gradient(#4174dc, #293ec2);">
      <div class="modal-header border-bottom-0">
        <h5 class="modal-title" id="exampleModalLabel" style="text-align:center;color:white;margin-left:40px;box-sizing:border-box">Bring your Free Domain <br>to live </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
        
      </div>
    <form action="https://apponrents.com/app/domain.php" method="post">
        <div class="modal-body" >
          <div class="input-group">
                  <input type="search" name="dom"  placeholder="Register A Domain Name to Start" aria-label="Search" aria-describedby="search-addon" style="border-radius:5px 0px 0px 5px; width:80%" />
                  <button type="submit" class="btn btn-danger" style="border-radius:0px 5px 5px 0px">search</button>
    ...
    <form>
        <div class="modal-body">
          <div class="form-group">
            <label for="domain" style="font-size:15px">Please Enter Your Domain Name:</label>
            <br>
                        ...
                        <div class="mt-3" id="time_slots">
                            <?php foreach ($time_slots as $row) { ?>
                                ...
                                <div class="custom-control custom-radio">
                                    <input id="<?= $row['id'] ?>" name="delivery_time" type="radio" class="custom-control-input time-slot-inputs" data-last_order_time="<?= $row['last_order_time'] ?>" value="<?= $row['title'] ?>" checked>
                                ...
                                <tbody>
                                    ...
                                    <?php if (isset($payment_methods['razorpay_payment_method']) && $payment_methods['razorpay_payment_method'] == 1) { ?>
                                        <tr>
                                            <td>
                                                <label for="razorpay">
                                                    <input id="razorpay" name="payment_method" type="radio" value="Razorpay" checked>
                                                </label>
                                            </td>
                                            <td>
                                                <label for="razorpay">
