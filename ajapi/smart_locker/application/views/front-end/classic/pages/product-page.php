    ...
    <div class="row mx-0">
                    ...
                    <div class="swiper-slide">
                        <div class='product-view-grid'>
                            <div class='product-view-image'>
                                <div class='product-view-image-container' style="height: 350px !important;width: 465px !important;">
        ...
        <div class="col-12 col-md-6 product-page-details">
            ...
            <div class="pt-3 text-md-left">
                ...
                <a href="<?php foreach($abc as $ab){ echo $ab['live_privewe']; } ?>"><button class="buttons btn-6-1 extra-small" >Live Preview</button></a>
                                    ...
                                    for ($j = 0; $j < count($review_images['product_rating'][$i]['images']); $j++) {
                                        if ($count <= 8) {
                                            ...
                                            <?php } else if (!empty($review_images['product_rating'][$i]['images'][$j])) { ?>
                                                <div class="col-sm-1">
                                                    <div class="review-box">
                                                        <a href="<?= $review_images['product_rating'][$i]['images'][$j] ?>" data-lightbox="users-review-images" data-title="<?= "<button class='label btn-success'>" . $review_images['product_rating'][$i]['rating'] . " </button></br>" . $review_images['product_rating'][$i]['user_name'] . "<br>" . $review_images['product_rating'][$i]['comment'] ?> ">
