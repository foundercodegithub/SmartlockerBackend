                ...
                <div id="leftside-navigation" class="nano">
                    <ul class="nano-content">
                        ...
                        <?php } ?>
                                   ...
                                   <button onclick="https://seo.codescarts.com/seo/">Free Seo</button>
                        <li class="sub-menu">
                ...
                <div id="leftside-navigation" class="nano mobile-categories">
                    <ul class="nano-content">
                        ...
                        <li class="see-all-category">
                            <a href="<?= base_url('home/categories') ?>"><?= !empty($this->lang->line('see_all')) ? $this->lang->line('see_all') : 'Others' ?></a>
                        </li>
                    </ul>
                </div>
            </aside>
...
<div class="shopping-cart-sidebar is-closed-right bg-white">
    ...
    <div class="text-center mt-2"><a class="button button-success button-rounded view_cart_button" href="<?= base_url('cart/checkout') ?>"><?= !empty($this->lang->line('view_cart')) ? $this->lang->line('view_cart') : 'View Cart' ?></a></div>
</div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="topbar-right text-lg-right">
                        <ul class="list-inline">
                            ...
                            <li><a href="https://seo.codescarts.com/seo/dashboard" class="hide-sec">Free Seo 20+ tools</a></li>
                            
                            
                            <li><a href="https://seo.codescarts.com/site/" class="hide-sec">Seo tools</a></li>
                        ...
                        <?php $count = 1;
                                        ...
                                        ?>
                                            <a itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" itemprop="item" href="<?= base_url('products/category/' . $row['slug']) ?>">
                                                    ...
                                                    <span class="category-line-height" itemprop="name" style="
    color: black;"><?= $row['name'] ?></span>
                                        ...
                                        <a href="<?= base_url('home/categories') ?>">
                                            <li class="see-all-category">
                                                <?= !empty($this->lang->line('see_all')) ? $this->lang->line('see_all') : 'Others' ?>
