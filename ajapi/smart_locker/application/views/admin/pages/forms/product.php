                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <div class="row col mt-3">
                                            ...
                                            <div class="col-md-4">
                                                <label for="made_in" class="col-form-label">Live Preview </label>
                                                <input type="text" class="col-md-12 form-control" name="made_in" value="" placeholder='Enter the URL'>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="admin" class="col-form-label">Admin Preview </label>
                                                <input type="text" class="col-md-12 form-control" name="admin" value="" placeholder='Enter the URL'>
                                            </div>
                                            <div class="col-md-4">
