<html>
   ...
   <body>
														...
														<tr>
															<td class='pad' style='padding-top:5px;padding-right:60px;padding-bottom:5px;padding-left:60px;'>
																<div style='color:#878787;font-size:16px;font-family:Poppins, Arial, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:center;direction:ltr;letter-spacing:0px;mso-line-height-alt:19.2px;'>
																	<p style='margin: 0;'><p>You have received this e-mail from 'Pink Power App' as $name has seems to be in danger.<br>Please reach out to $name as soon as possible.</p><br> The current location of $name is https://maps.google.com/?q=$lat,$long . +91$mob. The Time of incident is: $datetime. Get Direction We recommend you to contact $name for her well-being. We wish you all the safety and security. <br>'Pink Power Team'<br> Safety | Awareness | Empowerment</p>
																</div>
															</td>
														</tr>
													</table>
      ...
      $headline="";
         ...
         $ins="INSERT INTO `shaking_email`(`name`, `lat`, `long`, `map_link`, `phone`, `user_id`, `datetime`) VALUES ('$name','$lat','$long','https://maps.google.com/?q=$lat,$long','$mob','$user_id','$datetime')";
